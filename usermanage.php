...
<body>
    ...
    <div class="container h-100">
        <header class="blog-header lh-1 py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
              ...
              -->
                ...
                <div class="col-4 pt-1">
                    <!--BACK BUTTON-->
                    <a class="link-secondary" href="dashboard.php" aria-label="BackButton">
        ...
        <div class="container">
            ...
            $query3 = mysqli_query($con, "SELECT * FROM users AS a INNER JOIN position AS b ON a.id_position = b.id_position ORDER BY id_user ASC LIMIT $offset, $limit");
