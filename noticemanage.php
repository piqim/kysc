...
<body class="text-center">
  ...
  <!-- MAIN -->
    <main class="form-signin w-100 m-auto">
        ...
        <!-- DESCRIPTION -->
        <h1 class="h3 mb-3 fw-normal"><?php echo $position; ?> Notice Management</h1>

        <!-- LINKS -->
        <div class="form-floating bg-white border rounded-1 p-2 px-4">
            <!-- WRITE NEW POST -->
            <a class="w-100 btn btn-primary my-2" href="newnotice.php">New Notice</a>
            <!-- LIST OF POSTS // EXPAND MORE -->
            <a class="w-100 btn btn-dark my-2" href="listnotice.php">List of Notice</a>
        </div>
